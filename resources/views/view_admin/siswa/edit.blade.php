...
<a href="/siswa" class="btn btn-primary mb-2">Kembali</a>
...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/updateSiswa/{{ $siswa->id }}" method="post">
                    @csrf
                    @method('put')
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="nama">Nama Lengkap</label>
                        <div class="col-sm-10">
                            <input autofocus value="{{ old('nama', $siswa->nama) }}" type="text"
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="kode_user">NIS</label>
                        <div class="col-sm-10">
                            <input autofocus value="{{ old('kode_user', $siswa->kode_user) }}" type="text"
                                class="form-control @error('kode_user') is-invalid @enderror" name=" kode_user"
                                id="kode_user" placeholder="NIS" required />
                            <div class="invalid-feedback text-danger">
                                @error('kode_user')
                                {{ $message }}
                                @enderror
