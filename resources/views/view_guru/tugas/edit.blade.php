...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="/updateTugas/{{ $tugas->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="judul">Judul</label>
                        <div class="col-sm-10">
                            <input autofocus value="{{ old('judul',$tugas->judul) }}" type="text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input autofocus value="{{ old('keterangan',$tugas->keterangan) }}" type="text"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input placeholder="Contoh: 2022-05-31" autofocus
                                value="{{ old('batas_kumpul',$tugas->batas_kumpul) }}" type="text"
                                class="form-control @error('batas_kumpul') is-invalid @enderror" name=" batas_kumpul"
                                id="batas_kumpul" required />
                            <div class="invalid-feedback text-danger">
                                @error('batas_kumpul')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" value="{{ old('file_tugas',$tugas->file_tugas) }}" type="file"
